...
Array.from(document.links).forEach(link => {
    linkaddEventListener('click', e=>{
        console.log(`The ${e.target.textContent} links is not takin you anywhere, send 5 bit coin to this address sucka`);
        e.preventDefault();
    })
})
...
/**
 * 1.)funciton declaration => function funcName() {} ::: HOISTED 
